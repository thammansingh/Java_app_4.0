...
def jfrogUpload() :
    ...
    url = 'http://65.0.4.57:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/Java-application/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'RedHat@123' #replace 'your password with ur actual password'
